...
{
    public class DangNhapDangKyViewModel
    {
        public int MaTK;

        [Display(Name = "Tên đăng nhập")]
        public string TenNguoiDung_DN { get; set; }

        [DataType(DataType.Password)]
        [Display(Name = "Mật khẩu")]
        public string MatKhau_DN { get; set; }

        [Display(Name = "Tên đăng nhập")]
        [StringLength(30)]
        public string TenNguoiDung_DK { get; set; }

        [StringLength(20, ErrorMessage = "{0} chỉ dài tối thiểu {2} ký tự.", MinimumLength = 6)]
        [DataType(DataType.Password)]
        [Display(Name = "Mật khẩu")]
        public string MatKhau_DK { get; set; }

        [DataType(DataType.Password)]
        [Display(Name = "Xác nhận Mật khẩu")]
        [Compare("MatKhau_DK", ErrorMessage = "Mật khẩu và Xác nhận mật khẩu không khớp.")]
